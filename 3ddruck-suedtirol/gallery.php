...
$items = [
    ...
    ['Gelenk-Klemme',         'functional', 'bi-wrench-adjustable',   'Einstellbare Klemme, PETG für spielfreien Sitz'],
    ['Wasserrinne Clip',      'functional', 'bi-droplet-fill',        'Regenrinnen-Befestigungsklammer, PETG wetterfest'],
